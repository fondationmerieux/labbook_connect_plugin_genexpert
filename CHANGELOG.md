...
## [1.0.11] - 2026-06-17
### Fixed
- LAB-27 ASTM O segment field alignment (Action Code position).
...
## [1.0.8] - 2026-04-21
### Fixed
- OBX-11 (result status) and correct OBX field alignment

## [1.0.7] - 2026-03-24
### Fixed
- Handled both LAB-27 query-all and specimen-specific queries
...
## [1.0.4] - 2026-02-16
### Fixed
- LAB-27 : use ASTM O segment status 'Q' instead of 'F' for LAB-27 query responses
